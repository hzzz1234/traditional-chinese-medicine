            ...
            if( that.put ){
                ...
                if( that.cid != 'init' ){
                    if( that.usechannel && that.cname ){
                        h += '<a style="padding-left:10px;border-bottom: solid 1px #eee;line-height: 42px;display:block;" href="javascript:;" data-pchannel="'+that.cname+'">点此选择 '+that.cname+' 频道下的所有页面</a>'
                    }
                    h += '<ul class="unstyled">'
                    for (var i = 0; i < m.length; i++) {
